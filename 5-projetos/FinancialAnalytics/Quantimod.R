...
addBBands()
chartSeries(PETR4.SA, subset = 'last 6 months')
addBBands()
...
library(quantmod)
dados_ibm = read.table("~/FinancialAnalytics/data/ibm-returns.csv", header = T)
head(dados_ibm)
